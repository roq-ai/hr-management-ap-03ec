  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Introducing HR Management Application: Your Ultimate Solution for Streamlined Human Resource Processes. Experience Efficiency and Accuracy Like Never Before."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Introducing HR Management Application: Your Ultimate Solution for Streamlined Human Resource Processes. Experience Efficiency and Accuracy Like Never Before.`}
            </Text>
            <Box
